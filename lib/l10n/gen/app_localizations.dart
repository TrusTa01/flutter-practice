...
abstract class AppLocalizations {
  ...
  /// List of pizza ingridients
  ///
  /// In en, this message translates to:
  /// **'Ingridients: pepperoni, cheese, tomato sauce'**
  String get pizzaIngridients;

  /// No description provided for @orderPizza.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =0{You havent ordered any pizza yet} =1{You ordered {count} pizza} other{You ordered {count} pizzas}}'**
  String orderPizza(int count);

  /// Order additional pizzas
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =0{Order pizza} =1{{count} pizza in order} other{Order {count} pizzas}}'**
  String orderPizzaButton(int count);

  /// Pizza size selectiom options
  ///
  /// In en, this message translates to:
