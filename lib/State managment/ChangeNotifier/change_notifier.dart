  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: ChangeNotifierProvider(
        create: (context) => MyChangeProvider(),
        child: MyHomePage(),
      ),
    );
  }
...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Change notifier'), centerTitle: true),
      body: ListView(
        children: [
...
class AppRootWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final provider = context.watch<MyChangeProvider>();
...
class MyChangeProvider extends ChangeNotifier {
  int _counter = 0;
