  ...
  Widget _buildDisplay() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(expression, style: const TextStyle(fontSize: 24, color: Color.fromARGB(179, 0, 0, 0))),
          Text(output, style: const TextStyle(fontSize: 80, fontWeight: FontWeight.w400, color: Color.fromARGB(255, 0, 0, 0))),
        ],
      ),
    );
  }
